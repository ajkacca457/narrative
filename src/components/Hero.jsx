...
const Hero = () => {
  return (
    <div className='w-screen h-screen flex flex-col justify-center items-center'>
        ...
        <p className='w-2/5 text-center my-[50px]'>At Narrative, as a premier social media marketing agency, we understand the power of storytelling in capturing attention, fostering engagement, and driving conversions.</p>
        <div>
